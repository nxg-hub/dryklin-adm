...
const DeleteModal = ({back}) => {
    return (
        ...
        <div className=" relative bg-white p-8 rounded-[7%] shadow-lg w-[500px] max-h-[200%] overflow-y-auto min-h-[400px] lg:min-h-[400px]">
            ...
            <div className="mt-5 flex items-center text-red-500 text-2xl font-bold justify-center">User Account Deleted Successfully</div>
            <div className="mt-5 flex items-center  text-lg text-gray-500 justify-center">You have successfully deleted this account</div>
