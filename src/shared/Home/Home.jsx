...
export default function Dashboard() {
    ...
    const orderColumns = [
        ...
        { key: "serviceType", title: "Service Type" },
        {
            key: "orderStatus",
            title: "Order Status",
            render: (value, row) => <StatusBadge status={value} variant={row.orderStatusVariant} />,
        },
        {
            key: "paymentStatus",
            title: "Payment Status",
            render: (value, row) => <StatusBadge status={value} variant={row.paymentStatusVariant} />,
        },
    ]

    const analyticsData = {
        login: {
            labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Aug"],
