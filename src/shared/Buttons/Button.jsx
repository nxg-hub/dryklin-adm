export default function Button({
    ...
    const baseStyles = "rounded font-medium transition-colors focus:outline-none flex items-center justify-center";
    ...
    const variantStyles = {
        ...
        outline: "bg-white border border-[#D0D5DD] text-[#344054] hover:bg-gray-50 shadow-xs", // New outline variant
