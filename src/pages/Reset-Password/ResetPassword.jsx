            ...
            <div className="w-full max-w-md mt-20">
                {!isSubmitted ? (
                    <>
                        ...
                        <p className="text-[#6A6A6A] mb-8">Input your email address below</p>
                    ...
                    <div className="text-center">
                        <h2 className="text-[#E85C13] text-2xl font-semibold mb-4">Check Your Email</h2>
                        <p className="text-[#706f6f] mb-2">We've sent a password reset link to:</p>
