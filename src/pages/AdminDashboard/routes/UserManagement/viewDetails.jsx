    ...
    <div className="container mx-auto py-6 px-4">
      ...
      <div className="mt-5 text-black text-xl font-medium flex items-center gap-5 ">
        <img
          ...
          src="https://randomuser.me/api/portraits/men/1.jpg" // Sample image
          alt="User Image"
        />
        <div>
        ...
        <div className="group w-full md:w-auto">
          ...
          <div className="flex items-center gap-2 mt-3">
            ...
            <FaRegCopy
              className="ml-8 h-5 w-5 text-gray-400 cursor-pointer hover:text-black"
              onClick={() =>
                handleCopy("Jamesdavid@gmail.com", "Email Address")
              }
            />
            {copied === "Jamesdavid@gmail.com" && (
              <span className="text-sm text-[#E85C13]">Copied!</span>
            )}
          </div>
        </div>
      ...
      <div className="container px-10 mt-20 flex justify-end text-black">
        <div className="flex items-center gap-5">
          ...
          {/* Deactivate Button */}
          <button
            className="bg-[#E85C19] text-white px-8 py-4 rounded-lg hover:bg-[#c74e10] transition flex items-center gap-2"
