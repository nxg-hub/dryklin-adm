...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center p-6 m-auto">
      <div className="flex justify-start absolute top-6 left-6">
        <Logo />
      </div>

      <div className="w-full max-w-md mt-20">
        <h2 className="text-3xl font-medium text-[#E85C13] text-center mb-2">
          Welcome
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex justify-end">
              <a
                href="/reset-password"
                className="text-[#E85C13] hover:underline">
                Forgotten Password
              </a>
            </div>
          </div>
