  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center border-2 border-[#a0a0a0] bg-black/40 overflow-y-auto p-4 z-[1000]">
      <div className=" relative bg-white p-8 rounded-[7%] shadow-lg w-[500px] max-h-[200%] overflow-y-auto min-h-[400px] lg:min-h-[400px]">
        ...
        <div className="mt-5 flex items-center  text-lg text-gray-500 justify-center">
          Are you sure you want to suspend this account? This action cannot be
          undone.
        </div>
        <button
          className="bg-red-600 text-white text-2xl font-bold px-5 mt-7 py-2 rounded-lg w-full hover:bg-[#c74e10] transition flex items-center justify-center"
